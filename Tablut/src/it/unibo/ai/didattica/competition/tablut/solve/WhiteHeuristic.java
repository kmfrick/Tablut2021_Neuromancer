...
public class WhiteHeuristic {
	...
	*/
	...
	/* I would delete this function. How can the white player, with a new state generated by an himself's move
	lose a piece? Otherwise, could be good if the difference between white and black is meaningful for future
	heuristics function
